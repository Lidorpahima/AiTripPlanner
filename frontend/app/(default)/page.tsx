  ...
  return (
    <>
      ...
      <section className="relative px-4 sm:px-6 md:px-8 py-4 sm:py-10 md:py-12 bg-transparent">
        <div className="absolute inset-0 bg-[url('/mobile/60.webp')] md:bg-[url('/desktop/60.webp')] bg-fill bg-center bg-no-repeat opacity-100">
        </div>
      ...
      {/* How It Works Section */}
      <section className="relative  lg:py-20 bg-transparent overflow-hidden px-4 sm:px-6 md:px-8" id="how-it-works">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      ...
      {/* Popular Destinations Section */}
      <section className="relative lg:py-20 bg-transparent overflow-hidden px-4 sm:px-6 md:px-8">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
